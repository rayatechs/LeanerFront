    ...
    <div className="[--header-height:calc(--spacing(12))]">
      <SidebarProvider className="flex flex-col">
        ...
        <div className="flex flex-row w-full h-full">
          ...
          <SidebarInset className="!m-0 !rounded-l-none !rounded-b-none fixed inset-y-0 top-(--header-height) h-[calc(100svh-var(--header-height)-calc(var(--spacing) * 2))]! w-[calc(100%-var(--sidebar-width))]! left-0 overflow-y-auto peer-data-[state=collapsed]:w-[calc(100%-var(--sidebar-width-icon)-20px)]! transition-[left,right,width] duration-200 ease-linear">
            <SiteHeader />
