...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 rtl:pr-8 pl-8 rtl:pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground ml-auto rtl:ml-0 rtl:mr-auto text-xs tracking-widest",
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronLeftIcon className="ml-auto rtl:ml-0 rtl:mr-auto size-4" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
